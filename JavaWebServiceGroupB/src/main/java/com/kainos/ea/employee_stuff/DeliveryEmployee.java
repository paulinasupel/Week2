...
public class DeliveryEmployee extends Employee{
    ...
    public DeliveryEmployee(short number, int salary, String firstName, String lastName, String bankAccountNumber, String niNumber, String phoneNumber, String email, String cv, String image, String favTech) {
